...
public class ProductController {
	...
	public ResponseEntity<ProductsEntity> getProduct(@PathVariable Integer product_id){
		Optional<ProductsEntity> opt = productservice.getSpecificProduct(product_id);
		return ResponseEntity.ok(opt.get());
	}
	
//	//for service to service communication
//		@GetMapping("/Product/{product_id}")
//		public ResponseEntity<ProductsEntity> getCartAddedProduct(@PathVariable Integer product_id){
//			Optional<ProductsEntity> opt = productservice.cartProduct(product_id);
//			return ResponseEntity.ok(opt.get());
//		}
